...
def ha_augment_sample(data, jitter_paramters=[0.5, 0.5, 0.2, 0.05], patch_ratio=0.7, scaling_amplitude=0.2,
                      max_angle=pi / 4):
    ...
    #target_img = non_spatial_augmentation(target_img, jitter_paramters=jitter_paramters, color_order=color_order,
    #                                      to_gray=to_gray)
    #source_img = non_spatial_augmentation(source_img, jitter_paramters=jitter_paramters, color_order=color_order,
    #                                      to_gray=to_gray)
